...
import { getAllCountries, getBranchOfficeByBusinessUnit, getBusinessUnitByCountry, getClacomDataByParameters, selectShortening } from "../../features/shortening/shorteningSlice";
...
const Filters = ({
  ...
  const filterTable = async (e: any) => {
    ...
    selectedClacom.forEach((element) =>
      factorFilterByClacom.push(element.clacom)
    ); //push only clacom parameter to array
